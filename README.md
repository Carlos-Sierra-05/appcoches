...
- Esta aplicación usa el servidor de desarrollo de Flask, **no** es apto para producción
- Para producción, se recomienda usar un servidor WSGI como Gunicorn
- Las imágenes se almacenan localmente en `backend/uploads/coches/`
- El volumen de MySQL persiste los datos entre reinicios
...
Este proyecto ha sido desarrollado como parte de un trabajo académico para demostrar:
...
4. Verifica que los puertos 3306, 5000 y 8000 estén libres

---

**Desarrollado con ❤️ para el aprendizaje de tecnologías web modernas**